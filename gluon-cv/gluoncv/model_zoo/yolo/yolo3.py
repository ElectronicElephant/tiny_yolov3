...
from .darknet import _conv2d, tiny_darknet
from .yolo_target import YOLOV3TargetMerger
from ...loss import YOLOV3Loss

__all__ = ['TinyYOLOV3', 'get_yolov3', 'yolo3_tiny_darknet_coco']
...
class YOLOOutputV3(gluon.HybridBlock):
    ...
    def hybrid_forward(self, F, x, anchors, offsets):
        ...
        detections = F.concat(ids, scores, bboxes, dim=-1)  # r_all, dim=-1)
        # reshape to (B, xx, 4+2) bbox, id+scores
...
class YOLODetectionBlockV3(gluon.HybridBlock):
    ...
    def __init__(self, channel, norm_layer=BatchNorm, norm_kwargs=None, **kwargs):
        ...
        with self.name_scope():
            ...
            # Tiny-YOLOv3 does not contain `body`
...
def yolo3_tiny_darknet_coco(pretrained_base=False, pretrained=False,
    ...
    stages = [base_net.features[:9], base_net.features[9:]]
    anchors = [[10, 14, 23, 27, 37, 58], [81, 82, 135, 169, 344, 319]]
    strides = [16, 32]
    classes = COCODetection.CLASSES
    return get_yolov3(
        'tiny_darknet', stages, [512, 256], anchors, strides, classes, 'coco',
